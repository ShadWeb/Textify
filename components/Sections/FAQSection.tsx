...
const FAQSection: React.FC = () => {
  ...
  const faqs: FAQItem[] = [
    ...
    },
    {
      ...
      answer:
        "در حال حاضر، WordifyImage از زبان‌های فارسی و انگلیسی با دقت بالا پشتیبانی می‌کند. ما در حال کار برای افزودن زبان‌های بیشتر در آینده هستیم.",
    },
    {
      question: "آیا استفاده از این سرویس رایگان است؟",
      answer:
        "بله، استفاده از ویژگی‌های اصلی WordifyImage کاملاً رایگان است. ممکن است در آینده برای کاربران حرفه‌ای با نیازهای خاص، پلن‌های ویژه‌ای ارائه شود.",
    },
  ];
